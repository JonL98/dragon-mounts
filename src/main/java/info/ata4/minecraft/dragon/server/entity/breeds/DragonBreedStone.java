 ...
 */
public class DragonBreedStone extends DragonBreed {
    
    private final Map<EntityTameableDragon, EntityAIRestrictSun> appliedTasks = new HashMap<>();

    DragonBreedStone() {
        super("stone", 0x555555);
        
        addHabitatBlock(Blocks.STONE);
        addHabitatBlock(Blocks.COBBLESTONE);
        addHabitatBlock(Blocks.STONEBRICK);

        addHabitatBiome(Biomes.STONE_BEACH);
    }
