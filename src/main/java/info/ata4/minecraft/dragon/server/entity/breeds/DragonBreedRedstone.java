 ...
 */
public class DragonBreedRedstone extends DragonBreed {
    
    private final Map<EntityTameableDragon, EntityAIRestrictSun> appliedTasks = new HashMap<>();

    DragonBreedRedstone() {
        super("redstone", 0xb00000);
        
        addHabitatBlock(Blocks.REDSTONE_WIRE);
        addHabitatBlock(Blocks.REDSTONE_ORE);
        addHabitatBlock(Blocks.REDSTONE_BLOCK);
        addHabitatBlock(Blocks.REDSTONE_LAMP);
    }
